...
const DASHBOARD_TRANSLATIONS: Record<Exclude<SessionLocale, "pt-BR">, Record<string, string>> = {
  "en-US": {
    ...
    "Saldo compartilhado, uso por profissional, cotas e visibilidade dos relatórios da clínica.": "Shared balance, per-professional usage, quotas and report visibility for the clinic.",
    "Dashboard detalhado": "Detailed dashboard",
    "Administrativo": "Administration",
    "Sair": "Sign out",
    "Resumo profissional": "Professional summary",
    "Pacientes": "Patients",
    "Buscar paciente...": "Search patients...",
    "Buscar paciente": "Search patients",
    "Nenhum paciente encontrado para esta busca.": "No patient found for this search.",
    "Devido": "Due",
    "Recebido": "Received",
    "Pendente": "Pending",
    "Carga": "Load",
    ...
    "Incluir Paciente": "Add Patient",
    "Paciente aguardando atendimento": "Patient waiting for care",
    "Pacientes aguardando atendimento": "Patients waiting for care",
    "Retome a sala original sem criar outro convite.": "Resume the original room without creating another invitation.",
    "Atender": "Attend now",
    "desde": "since",
    "Idioma": "Language",
    "Sessão Remota": "Remote Session",
    "Presencial": "In person",
    "Presencial · Celular": "In person · Patient's phone",
    "Ambos juntos na mesma sala; o celular do paciente funciona como câmera dedicada e o áudio dele não é reproduzido (evita eco). Não use se o paciente estiver remoto.": "Both together in the same room; the patient's phone works as a dedicated camera and their audio is not played back (avoids echo). Do not use if the patient is remote.",
    "Paciente e profissional em locais diferentes. O paciente entra pelo celular ou computador, com áudio e vídeo funcionando nos dois sentidos, incluindo o botão \"Ouvir paciente\".": "Patient and professional in different locations. The patient joins from a phone or computer, with two-way audio and video, including the \"Listen to patient\" button.",
    "Ambos juntos na mesma sala, usando só o dispositivo do profissional: a câmera e o microfone dele capturam o paciente diretamente, sem chamada nem áudio reproduzido.": "Both together in the same room, using only the professional's own device: their camera and microphone capture the patient directly, with no call and no audio played back.",
  ...
  "fr-FR": {
    ...
    "Gestão da clínica": "Gestion de la clinique",
    "Saldo compartilhado, uso por profissional, cotas e visibilidade dos relatórios da clínica.": "Solde partagé, utilisation par professionnel, quotas et visibilité des rapports de la clinique.",
    "Dashboard detalhado": "Tableau détaillé",
    "Administrativo": "Administration",
    "Sair": "Se déconnecter",
    "Resumo profissional": "Synthèse professionnelle",
    "Pacientes": "Patients",
    "Buscar paciente...": "Rechercher un patient...",
    "Buscar paciente": "Rechercher un patient",
    "Nenhum paciente encontrado para esta busca.": "Aucun patient trouvé pour cette recherche.",
    "Devido": "Dû",
    "Recebido": "Reçu",
    "Pendente": "En attente",
    "Carga": "Charge",
    ...
    "Incluir Paciente": "Ajouter un patient",
    "Paciente aguardando atendimento": "Patient en attente",
    "Pacientes aguardando atendimento": "Patients en attente",
    "Retome a sala original sem criar outro convite.": "Reprenez la salle initiale sans créer une nouvelle invitation.",
    "Atender": "Prendre en charge",
    "desde": "depuis",
    "Idioma": "Langue",
    "Sessão Remota": "Séance à distance",
    "Presencial": "Présentiel",
    "Presencial · Celular": "Présentiel · Téléphone du patient",
    "Ambos juntos na mesma sala; o celular do paciente funciona como câmera dedicada e o áudio dele não é reproduzido (evita eco). Não use se o paciente estiver remoto.": "Tous deux ensemble dans la même pièce ; le téléphone du patient sert de caméra dédiée et son audio n'est pas restitué (évite l'écho). À ne pas utiliser si le patient est à distance.",
    "Paciente e profissional em locais diferentes. O paciente entra pelo celular ou computador, com áudio e vídeo funcionando nos dois sentidos, incluindo o botão \"Ouvir paciente\".": "Patient et professionnel dans des lieux différents. Le patient se connecte depuis un téléphone ou un ordinateur, avec audio et vidéo dans les deux sens, y compris le bouton « Écouter le patient ».",
    "Ambos juntos na mesma sala, usando só o dispositivo do profissional: a câmera e o microfone dele capturam o paciente diretamente, sem chamada nem áudio reproduzido.": "Tous deux ensemble dans la même pièce, en utilisant uniquement l'appareil du professionnel : sa caméra et son microphone captent le patient directement, sans appel ni audio restitué.",
  ...
  "es-ES": {
    ...
    "Saldo compartilhado, uso por profissional, cotas e visibilidade dos relatórios da clínica.": "Saldo compartido, uso por profesional, cuotas y visibilidad de los informes de la clínica.",
    ...
    "Buscar paciente": "Buscar paciente",
    "Nenhum paciente encontrado para esta busca.": "No se encontró ningún paciente para esta búsqueda.",
    "Devido": "Devengado",
    "Recebido": "Recibido",
    "Pendente": "Pendiente",
    "Carga": "Carga",
    ...
    "Incluir Paciente": "Añadir paciente",
    "Paciente aguardando atendimento": "Paciente esperando atención",
    "Pacientes aguardando atendimento": "Pacientes esperando atención",
    "Retome a sala original sem criar outro convite.": "Retome la sala original sin crear otra invitación.",
    "Atender": "Atender ahora",
    "desde": "desde",
    "Idioma": "Idioma",
    "Sessão Remota": "Sesión remota",
    "Presencial": "Presencial",
    "Presencial · Celular": "Presencial · Móvil del paciente",
    "Ambos juntos na mesma sala; o celular do paciente funciona como câmera dedicada e o áudio dele não é reproduzido (evita eco). Não use se o paciente estiver remoto.": "Ambos juntos en la misma sala; el móvil del paciente funciona como cámara dedicada y su audio no se reproduce (evita el eco). No lo use si el paciente está remoto.",
    "Paciente e profissional em locais diferentes. O paciente entra pelo celular ou computador, com áudio e vídeo funcionando nos dois sentidos, incluindo o botão \"Ouvir paciente\".": "Paciente y profesional en lugares diferentes. El paciente entra desde el móvil o el ordenador, con audio y vídeo en ambos sentidos, incluido el botón «Escuchar al paciente».",
    "Ambos juntos na mesma sala, usando só o dispositivo do profissional: a câmera e o microfone dele capturam o paciente diretamente, sem chamada nem áudio reproduzido.": "Ambos juntos en la misma sala, usando solo el dispositivo del profesional: su cámara y micrófono capturan al paciente directamente, sin llamada ni audio reproducido.",
