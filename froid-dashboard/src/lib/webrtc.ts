...
//
// Houve um 4405 aqui, por algumas horas do mesmo dia: o recorte por
// organizacao recusando o profissional. Ele saiu porque a regra mudou — o
// servidor deixou de recusar o AUTOR da sessao por esse motivo (autoria antes
// de recorte, decisao do dono em 20/09/2026), e codigo que ninguem emite e
// mensagem que ninguem pode receber.
