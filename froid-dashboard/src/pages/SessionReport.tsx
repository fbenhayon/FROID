...
function summaryMetricLine(cut?: MetricSnapshot) {
  ...
  return [
    ...
    `Disson. ${fmt(cut.dissonanceCount, 0)}`,
  ...
  const series: SerieEvolucao[] = [
    {
      ...
      referencia: analysis.summary.ipm?.baseline ?? null,
      referenciaRotulo: "baseline",
      casas: 1,
    },
    {
      key: "idm",
      ...
      referencia: analysis.summary.idm?.baseline ?? null,
      referenciaRotulo: "baseline",
      casas: 2,
    },
    {
      ...
      referencia: analysis.summary.words_per_minute?.baseline ?? null,
      referenciaRotulo: "baseline",
      casas: 0,
    },
    {
      ...
      referencia: analysis.summary.facial_vocal_dissonance?.baseline ?? null,
      referenciaRotulo: "baseline",
      casas: 2,
    },
  ];
    ...
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
      {series.map((serie) => (
        <PainelEvolucao
          ...
          serie={serie}
          rotulos={rotulos}
          titulo={<HelpMetric label={serie.label} chave={serie.key} />}
        />
      ))}
    </div>
  );
