        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-[11px] opacity-80 mt-1">
              Iniciar avaliação multimodal com captura bioacústica e facial.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-[11px] text-slate-500 mt-1">
              12 sessões arquivadas (prontuário criptografado).
            </p>
          </button>
          ...
          >
            ...
            <p className="text-[11px] text-slate-500 mt-1">
              Agenda Google, planos de sessão e credenciais.
            </p>
          </button>
        </div>
              ...
              >
                <div>
                  <p className="text-sm font-semibold text-slate-700">
                    Paciente Anônimo #{9821 + i}
                  </p>
                  <p className="text-[11px] text-slate-400 mt-0.5">
                    {new Date(Date.now() - i * 86400000).toLocaleDateString(
                      "pt-BR",
                    )}{" "}
                    • Duração 47min • IPM médio 62.4
                  </p>
                </div>
