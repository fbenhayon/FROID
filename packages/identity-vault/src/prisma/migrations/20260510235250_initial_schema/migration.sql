/*
  ...
  - You are about to drop the `AnonymizationRecord` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `LegalEvent` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `LegalText` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `ShareRecord` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "ConsentRecord" DROP CONSTRAINT "ConsentRecord_legalTextId_fkey";

-- DropForeignKey
ALTER TABLE "ConsentRecord" DROP CONSTRAINT "ConsentRecord_patientId_fkey";

-- DropForeignKey
ALTER TABLE "ConsentRecord" DROP CONSTRAINT "ConsentRecord_professionalId_fkey";

-- DropForeignKey
ALTER TABLE "DeletionRequest" DROP CONSTRAINT "DeletionRequest_patientId_fkey";

-- DropForeignKey
ALTER TABLE "LegalEvent" DROP CONSTRAINT "LegalEvent_relatedConsentId_fkey";

-- DropForeignKey
ALTER TABLE "Session" DROP CONSTRAINT "Session_patientId_fkey";

-- DropForeignKey
ALTER TABLE "Session" DROP CONSTRAINT "Session_professionalId_fkey";

-- DropTable
DROP TABLE "AnonymizationRecord";
...
-- DropTable
DROP TABLE "LegalEvent";

-- DropTable
DROP TABLE "LegalText";
...
CREATE TABLE "clinic_prompts" (
    ...
    CONSTRAINT "clinic_prompts_pkey" PRIMARY KEY ("id")
);
