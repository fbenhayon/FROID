...
METRICS: tuple[dict[str, str], ...] = (
    ...
    {"key": "spectral_beta", "label": "Beta vocal 12-30Hz", "unit": "energia", "category": "Modulacao vocal"},
    {"key": "spectral_gamma", "label": "Gama vocal 30-80Hz", "unit": "energia", "category": "Modulacao vocal"},
    {"key": "spectral_band_index", "label": "Indice espectral vocal", "unit": "0-1", "category": "Modulacao vocal"},
    ...
    {"key": "jitter", "label": "Jitter idx.", "unit": "proxy 0-1", "category": "Bioacustica"},
    {"key": "shimmer", "label": "Shimmer idx.", "unit": "proxy 0-1", "category": "Bioacustica"},
