...
OBJETO_PSIQUE = (
    ...
    "contrato próprio, o do FROID NR-1. "
    "Os dois serviços podem ser contratados pela mesma empresa e articulados "
    "entre si, e o FROID Psique pode ser o canal de apoio ao trabalhador que a "
    "campanha de avaliação exige — mas a articulação é de finalidade, nunca de "
    "dado: o vínculo clínico se estabelece entre o trabalhador e o profissional "
    "que o atende, por iniciativa do trabalhador, e nenhuma informação "
    "individual retorna ao empregador, inclusive a de quem procurou o canal."
)
...
DOCUMENT_TEMPLATES["nr1_company_contract"] = {
    ...
    "sections": [
        ...
        ["Canal de apoio e articulação com o FROID Psique", "A campanha não é aberta sem canal de apoio ao trabalhador declarado — o sistema recusa, porque perguntar a alguém como ele está sem ter para onde encaminhá-lo é pior do que não perguntar. A contratante pode designar como canal o FROID Psique, contratado em instrumento próprio, e pode registrar essa disponibilização como medida de prevenção no plano de ação. Nessa hipótese, e em qualquer outra: a procura pelo canal é ato do trabalhador, o vínculo clínico se estabelece entre ele e o profissional que o atende, e a contratante não recebe identificação de quem procurou, conteúdo de atendimento, prontuário, quantidade de sessões por pessoa nem qualquer dado que permita inferir quem usou o canal. A eficácia dessa medida, como a de qualquer outra, é aferida pela campanha seguinte, sobre a condição de trabalho do recorte — nunca sobre a evolução clínica de quem foi atendido."],
